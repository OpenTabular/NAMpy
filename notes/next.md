Formula layer not yet mgcv-complete. nampy/gam/formula/parser.py:92 rejects
  ...
  - Gaussian cyclic cubic shared-basis and factor-by slices now pass targeted
    fixed-sp/REML parity checks; remaining gap is automatic ML, which still
    raises until exact Gaussian ML derivatives/Hessians are implemented.
