#!/usr/bin/env python3
"""
Verification example for TreeNAMRegressor on synthetic piecewise-additive data.
...
Run:
    python examples/example_treenam.py
"""
...
def main():
    ...
    # TreeNAM should be a strong fit for this style of target.
    # ------------------------------------------------------------------
    def f_age(age):
        return np.select(
            [
    ...
    # ------------------------------------------------------------------
    # TreeNAM model
    # Note: categorical features are returned as logical feature blocks, so
    # we expect "region", not region[0], region[1], ...
    # ------------------------------------------------------------------
