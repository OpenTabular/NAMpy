"""
Basic smoke tests for gevlss family (GEV location-scale-shape).

Tests:
1. _ShiftedLogitLinkInfo roundtrip and range
...
5. gevlss initialize returns correct-shaped finite vector
6. gam_fit5 convergence on simulated GEV data

Mirrors mgcv gevlss behaviour at a high level.
"""
import numpy as np
import pytest
...
from nampy.gam.families.gamlss import GevlssFamily, gevlss, _ShiftedLogitLinkInfo
