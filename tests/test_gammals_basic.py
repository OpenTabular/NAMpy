"""
Basic smoke tests for gammals family (Gamma location-scale).

Tests:
1. _SoftplusBLinkInfo roundtrip (linkfun / linkinv)
2. _SoftplusBLinkInfo mu_eta finite-difference check
3. _SoftplusBLinkInfo d2link finite-difference check
...
7. gammals initialize returns correct-shaped finite vector
8. gam_fit5 convergence on simulated gamma data

Mirrors mgcv gammals behaviour at a high level; not full parity snapshots.
"""
import numpy as np
import pytest
...
from nampy.gam.families.gamlss import GammalsFamily, gammals, _SoftplusBLinkInfo
