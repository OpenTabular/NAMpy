...
def make_norm(norm: Optional[str], size: int) -> Optional[nn.Module]:
...
class _ResidualBlock(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        norm_layer = make_norm(norm_name, n_output)
...
class MLP(nn.Module):
    ...
    output_bias : bool, default=True
        Whether the final linear layer includes a bias.
    """
    ...
    def __init__(
        ...
        self.linear_final = nn.Linear(
            input_units, n_output_units, bias=bool(output_bias)
        )
