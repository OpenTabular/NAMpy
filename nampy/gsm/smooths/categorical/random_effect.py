...
from ..base import BaseSmoothTerm, _resolve_feature, _resolve_numeric_by
from ..tensor.ops import rowwise_kronecker
...
class RandomEffectTerm(BaseSmoothTerm):
    ...
    def transform_new(self, X_new):
        ...
        for idx, spec in zip(self._feature_indices, self._component_specs):
            blocks.append(_predict_re_component(X_new[:, idx], spec))
