...
class NodeGAMRegressor(SklearnBaseRegressor):
    ...
    layer_sizes : list, default=(128, 128, 32)
        Sizes of the layers in the NodeGAM.
    activation : callable, default=nn.SELU()
        Activation function for the NodeGAM layers.
    skip_layers : bool, default=False
        Whether to skip layers in the NodeGAM.
    dropout : float, default=0.5
        Dropout rate for regularization.
    norm : str, default=None
        Normalization method to be used, if any.
    use_glu : bool, default=False
        Whether to use Gated Linear Units (GLU) in the NodeGAM.
    skip_connections : bool, default=False
        Whether to use skip connections in the NodeGAM.
    batch_norm : bool, default=False
        Whether to use batch normalization in the NodeGAM layers.
    layer_norm : bool, default=False
        Whether to use layer normalization in the NodeGAM layers.
