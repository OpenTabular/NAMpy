...
class DaviesAlgorithm:
    ...
    def _integrate(self, nterm, interv, tausq, main, c, acc, intl, ersm, sigsq, r, n, lb, nc):
        pi = math.pi
        inpi = interv / pi
    ...
    def davies(self, lb, nc, n, r, sigma, c_val, lim, acc):
        ...
        while True:
            ...
            if nt > ntm * 1.5:
                ...
                self._integrate(ntm, intv1, tausq, False, c_val, acc, intl, ersm, sigsq, r, n, lb, nc)
                lim -= ntm
                sigsq += tausq
                trace[2] += 1.0
                trace[1] += ntm + 1
        ...
        self._integrate(nt, intv, 0.0, True, c_val, acc, intl, ersm, sigsq, r, n, lb, nc)
        trace[2] += 1
        trace[1] += nt + 1
        result_c = 0.5 - intl[0]
        trace[0] = ersm[0]
